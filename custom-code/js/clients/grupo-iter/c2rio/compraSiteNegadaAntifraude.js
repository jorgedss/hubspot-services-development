...
// ---------------------------------------------------------------------------
// Grupo Iter - BU C2Rio - evento compra-site-negada-antifraude (SIG).
//
...
// na etapa Perdido com motivo_de_perda "Pagamento recusado (antifraude)".
//
...
exports.main = async (event, callback) => {
  ...
  console.log(
    `[c2rioCompraSiteNegadaAntifraude] contato ${contactId} | booking ${bookingKey}`,
  );
  ...
  try {
    ...
    console.log(
      `[c2rioCompraSiteNegadaAntifraude] contato ${contactId} atualizado; deal ${resolvedDealId} na etapa Perdido`,
    );
    ...
    console.error("[c2rioCompraSiteNegadaAntifraude] error:", buildErrorMessage(error));
    throw error;
  }
};
