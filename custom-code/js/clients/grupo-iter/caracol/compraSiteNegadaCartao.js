...
exports.main = async (event, callback) => {
  ...
  console.log(
    `[caracolCompraSiteNegadaCartao] contato ${contactId} | booking ${bookingKey}`,
  );
  ...
  try {
    ...
    console.log(
      `[caracolCompraSiteNegadaCartao] contato ${contactId} atualizado; deal ${resolvedDealId} na etapa Perdido`,
    );
    ...
    console.error("[caracolCompraSiteNegadaCartao] error:", buildErrorMessage(error));
    throw error;
  }
};
