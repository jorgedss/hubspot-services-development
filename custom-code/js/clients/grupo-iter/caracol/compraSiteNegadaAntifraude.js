...
// ---------------------------------------------------------------------------
// Grupo Iter - BU Caracol - evento compra-site-negada-antifraude (SIG).
//
...
exports.main = async (event, callback) => {
  ...
  console.log(
    `[caracolCompraSiteNegadaAntifraude] contato ${contactId} | booking ${bookingKey}`,
  );
  ...
  try {
    ...
    console.error("[caracolCompraSiteNegadaAntifraude] error:", buildErrorMessage(error));
    throw error;
  }
};
